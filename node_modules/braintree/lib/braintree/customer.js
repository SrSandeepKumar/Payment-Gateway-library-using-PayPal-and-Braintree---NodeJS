...
var ApplePayCard, AttributeSetter, CoinbaseAccount, CreditCard, Customer, PayPalAccount,
...
Customer = (function(_super) {
  ...
  function Customer(attributes) {
    var cardAttributes, coinbaseAccountAttributes, paymentMethod, paypalAccountAttributes, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3;
    ...
    if (attributes.paypalAccounts) {
      this.paypalAccounts = (function() {
        ...
        _ref2 = attributes.paypalAccounts;
        _results = [];
        for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
          paypalAccountAttributes = _ref2[_k];
          _results.push(new PayPalAccount(paypalAccountAttributes));
        }
        return _results;
      })();
      _ref2 = this.paypalAccounts;
      for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
    ...
    if (attributes.coinbaseAccounts) {
      this.coinbaseAccounts = (function() {
        ...
        _ref3 = attributes.coinbaseAccounts;
        _results = [];
        for (_l = 0, _len3 = _ref3.length; _l < _len3; _l++) {
          coinbaseAccountAttributes = _ref3[_l];
          _results.push(new CoinbaseAccount(coinbaseAccountAttributes));
        }
        return _results;
      })();
      _ref3 = this.coinbaseAccounts;
      for (_l = 0, _len3 = _ref3.length; _l < _len3; _l++) {
