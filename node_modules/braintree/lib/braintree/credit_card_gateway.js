...
CreditCardGateway = (function(_super) {
  ...
  CreditCardGateway.prototype["delete"] = function(token, callback) {
    return this.gateway.http["delete"]("/payment_methods/credit_card/" + token, callback);
  };
  ...
  CreditCardGateway.prototype.find = function(token, callback) {
    if (token.trim() === '') {
      ...
      return this.gateway.http.get("/payment_methods/credit_card/" + token, function(err, response) {
        if (err) {
  ...
  CreditCardGateway.prototype.update = function(token, attributes, callback) {
    return this.gateway.http.put("/payment_methods/credit_card/" + token, {
      creditCard: attributes
    }, this.responseHandler(callback));
  };
